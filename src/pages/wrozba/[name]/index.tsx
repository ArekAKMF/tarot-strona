...
export default function Home() {
  ...
  const generateGameCards = () => {
    ...
    console.log(gameType, 'gameType', cardCout, 'ILE', cartToTest.length)
    let i = 0;
  ...
  return (
    <>
      ...
      <Container maxW="8xl">
        ...
        >
          <AlertDescription maxWidth='lg'>
            ...
            <Box maxW="200" margin="10px auto 0 auto">
              <Button colorScheme='blue' size='lg' onClick={() => generateGameCards()}>Rozłóż karty</Button>
            </Box>
          </AlertDescription>
        </Alert>
        ...
        >
          {
            activeElement && selectedCard.map((el: any, index: number) => (
              <Cards
